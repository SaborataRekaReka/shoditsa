...
docker compose -f "$ROOT/app/compose.production.yml" --profile migrate run --rm --no-deps --entrypoint node migrate apps/api/dist/content-import-dtf-comments.js --publish --report=/tmp/dtf-game-comments-25-import-report.json
