...
export const FACTCHECK_PACKS = {
  ...
  character: pack({ identityFields: ['characterSourceWork', 'characterSourceAuthor'], dependencies: { characterFirstAppearanceYear: ['characterSourceWork', 'characterSourceAuthor', 'characterEra'], characterAbilities: ['characterSourceWork', 'characterNature'] }, criticalFields: ['titleRu', 'characterSourceWork', 'characterFirstAppearanceYear'], sourcePolicy: sourcePolicies.character }),
