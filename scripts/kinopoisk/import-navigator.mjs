...
const defaultIdsPath = mode === 'series'
  ? 'data/kinopoisk/navigator/series/ids.json'
  : 'data/kinopoisk/navigator/movies/ids.json'
...
const skippedPath = resolve(root, argValue('--skipped', `data/kinopoisk/navigator/${mode === 'series' ? 'series' : 'movies'}/skipped.json`))
