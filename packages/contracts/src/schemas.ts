...
export const GameStartBodySchema = Type.Object({
  ...
  sourceSessionId: Type.Optional(UuidSchema),
}, { additionalProperties: false })
...
export const ContentReportReasonSchema = Type.Union([
  ...
  Type.Literal('ambiguous_group'),
  Type.Literal('wrong_group_title'),
  Type.Literal('word_does_not_fit'),
  Type.Literal('duplicate_word'),
