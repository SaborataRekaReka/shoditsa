...
export const gameSessions = pgTable('game_sessions', {
  ...
  check('game_session_access_source_check', sql`${table.accessSource} is null or ${table.accessSource} in ('tickets','club','registration_bonus','free_archive')`),
