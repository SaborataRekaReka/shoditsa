...
import { CATALOG_GUESS_MODE_IDS, type PeriodKey, type TitleItem, type TitleMode } from '@shoditsa/contracts'
import {
...
const modes = new Set<TitleMode>(CATALOG_GUESS_MODE_IDS)
