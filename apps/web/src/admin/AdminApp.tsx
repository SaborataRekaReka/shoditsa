...
function IntegrationsPage({ notify }: { notify: (tone: Notice['tone'], text: string) => void }) {
  ...
  const startPortraitTest = useMutation({
    mutationFn: (selection?: { portraitId?: 'sherlock-holmes'; portraitBatch?: 'character-expansion-50' }) => adminApi.startOpenAiPortraitTest(selection),
