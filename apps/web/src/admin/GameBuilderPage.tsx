...
export function GameBuilderPage({ notify, onNavigateContent }: { notify: (tone: NoticeTone, text: string) => void; onNavigateContent: () => void }) {
  ...
  const gameSubject: Record<ContentMode, string> = { movie: 'фильм', series: 'сериал', anime: 'аниме', game: 'игру', music: 'артиста', diagnosis: 'диагноз', city: 'город', animal: 'животное', danetki: 'данетку', connections: 'раунд связей' }
