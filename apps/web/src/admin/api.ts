...
export const adminApi = {
  ...
  pipelineManualPreview: (artists: Array<Record<string, unknown>>) => request<{ items: Array<Record<string, unknown>>; summary: Record<string, number> }>('/admin/pipelines/music/manual/preview', { method: 'POST', body: json({ artists }) }),
