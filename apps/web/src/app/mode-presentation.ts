...
export const MODE_PRESENTATION: Record<TitleMode, ModePresentation> = {
  ...
  game: { icon: Gamepad2, color: 'var(--mode-game-brand)', watermarkUrl: publicAssetUrl('images/category-stubs/game-stub.webp'), description: 'Угадайте игру по жанрам, рейтингу и Steam.', emptyHint: 'После ответа появятся сравнения по году, месту в топе, жанрам, категориям Steam и рейтингу.' },
  ...
  book: { icon: BookOpen, color: 'var(--mode-book-brand)', watermarkUrl: publicAssetUrl('images/category-stubs/book-stub.svg'), description: 'Угадайте книгу по автору, эпохе, жанрам и экранизациям.', emptyHint: 'После ответа появятся сравнения по автору, стране, языку, году публикации, жанрам, циклу, премиям и экранизациям.' },
}
