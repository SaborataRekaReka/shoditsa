...
const utilitySeo = (pathname: string): SeoRoute | null => {
  ...
  if (pathname === '/club') return {
    kind: 'utility', title: 'Клуб «Сходится!» — архив игр и свободная игра', description: 'Клубный доступ к архиву ежедневных выпусков и свободной игре без ожидания нового раунда.', canonicalPath: '/club', heading: 'Клуб «Сходится!»', lead: 'Архив ежедневных выпусков, свободная игра и клубные спецпоказы без автоматического продления.', paragraphs: ['Возвращайтесь к играм с первого дня работы сервиса и выбирайте удобный срок доступа.', 'Ежедневные игры, подсказки и заработанные билеты остаются бесплатными для всех пользователей.'], robots: INDEXABLE_ROBOTS, indexable: true, imagePath: DEFAULT_SOCIAL_IMAGE_PATH,
  }
