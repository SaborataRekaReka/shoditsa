...
describe('search index contract', () => {
  ...
  it('locks the established Danetki search cluster against accidental metadata drift', () => {
    const protectedRoutes = [
      ['/games/danetki', 'Данетки онлайн — играть бесплатно с ведущим | Сходится!', 'Играйте в данетки онлайн бесплатно: раскройте необычную историю вопросами с ответами «да» и «нет». Игра с ведущим одному или вместе.'],
