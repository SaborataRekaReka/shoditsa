...
const playerRoutes = [
  ...
  createRoute({ getParentRoute: () => playerLayoutRoute, path: 'danetki', component: RouteMarker }),
  createRoute({ getParentRoute: () => playerLayoutRoute, path: 'danetki/$slug', component: RouteMarker }),
